          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="mt-7 flex items-center gap-3 justify-center lg:justify-start">
              <div className="flex -space-x-2">
                {[
                  "https://api.dicebear.com/7.x/initials/svg?seed=R&backgroundColor=1a73e8",
                  "https://api.dicebear.com/7.x/initials/svg?seed=P&backgroundColor=34a853",
                  "https://api.dicebear.com/7.x/initials/svg?seed=A&backgroundColor=fbbc04",
                  "https://api.dicebear.com/7.x/initials/svg?seed=S&backgroundColor=ea4335"
                ].map((src) => (
                  <img
                    key={src}
                    src={src}
          ...
          <Reveal delay={0.1} className="order-1 lg:order-2 relative">
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute -right-6 -top-4 sm:-right-12 sm:-top-8 w-72 sm:w-80 rounded-xl border border-border bg-surface shadow-neu overflow-hidden hidden sm:block rotate-3">
                <div className="flex items-center gap-1 px-3 py-2 border-b border-border bg-elevated">
                  <span className="h-2.5 w-2.5 rounded-full bg-red-400" />
                  <span className="h-2.5 w-2.5 rounded-full bg-amber-400" />
                  <span className="h-2.5 w-2.5 rounded-full bg-green-400" />
                  <span className="ml-2 text-[10px] text-muted-foreground font-mono">app.reviewqr.in</span>
                </div>
                <div className="p-3 grid grid-cols-2 gap-2 bg-gradient-to-br from-brand/10 to-accent/10">
                  <div className="rounded-lg bg-elevated border border-border p-2.5">
                    <div className="text-[10px] text-muted-foreground">Reviews</div>
                    <div className="text-lg font-bold text-ink">1,284</div>
                    <div className="text-[10px] text-accent font-medium">+12%</div>
                  </div>
                  <div className="rounded-lg bg-elevated border border-border p-2.5">
                    <div className="text-[10px] text-muted-foreground">Avg</div>
                    <div className="text-lg font-bold inline-flex items-center gap-0.5 text-ink">
                      4.7 <Star className="h-3 w-3 fill-amber-400 text-amber-400" />
                    </div>
                    <div className="text-[10px] text-accent font-medium">+0.2</div>
                  </div>
                  <div className="col-span-2 rounded-lg bg-elevated border border-border p-2.5">
              ...
              <div className="absolute -left-4 sm:-left-12 top-1/3 w-56 rounded-xl bg-surface shadow-neu border border-border p-3 flex items-start gap-2 animate-fade-in">
                ...
                <div className="text-xs">
                  <div className="font-semibold text-ink">Ananya gave 5★</div>
                  <div className="text-muted-foreground">"Loved the masala dosa!"</div>
                </div>
              </div>

              {/* Floating WhatsApp ping */}
              <div className="absolute -right-2 sm:-right-10 bottom-10 w-52 rounded-xl bg-surface shadow-neu border border-border p-3 flex items-start gap-2 animate-fade-in">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366]">
                  <MessageCircle className="h-3.5 w-3.5" />
                </span>
                <div className="text-xs">
                  <div className="font-semibold text-ink">WhatsApp alert</div>
